...
> Accompanies the book — Chapter 7, "Tools, Function-Calling, and MCP" — the TixCore/CRM worked example

## What this demonstrates

An internal Model Context Protocol (MCP) server exposing a legacy ticketing system (the fictional 'TixCore') as governed tools, with per-technician-role access control.

## Prerequisites

- .NET 8 SDK
- Access to a test ticketing/CRM instance or the provided mock
