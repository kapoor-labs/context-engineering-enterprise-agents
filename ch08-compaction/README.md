...
Compaction (distilling a long-running context into a high-fidelity summary) and tool-result clearing (removing stale tool outputs), triggered as a session approaches its context-rot or context-window limit.
